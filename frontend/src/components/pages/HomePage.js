...
const HomePage = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-6">AI를 통해 뉴스에서 숨겨진 인사이트를 발견하세요.</h1>
            <p className="text-lg md:text-xl text-gray-600 mb-12">관심 키워드와 관련된 최신 뉴스들을 AI가 분석하여, 복잡한 정보 속에서 핵심을 파악할 수 있도록 돕습니다.</p>

            <div className="w-full max-w-3xl grid grid-cols-1 md:grid-cols-12 gap-4">
                <div className="col-span-full flex shadow-md rounded-lg overflow-hidden">
                    <input
                        type="text"
